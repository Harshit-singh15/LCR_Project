...
EXTRACT_DIR = "outputs_prerequisite/extracted_sequences"
PROTEIN_LENGTHS = "outputs_prerequisite/protein_lengths.tsv"
OUTPUT_DIR = "outputs_prerequisite/LCR_Coverage"

TOTAL_PROTEINS = 21852
...
# -----------------------------------------------------
# Build alias-aware length dictionary
# -----------------------------------------------------

length_dict = {}

for _, row in lengths_df.iterrows():

    pid = str(row["Protein_ID"])
    length = int(row["Protein_Length"])

    # canonical ID
    length_dict[pid] = length
