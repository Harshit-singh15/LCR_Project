...
INPUT_DIR = "outputs_prerequisite/extracted_sequences"

LENGTH_DIR = "outputs_prerequisite/LCR_Length"
COUNT_DIR  = "outputs_prerequisite/LCR_Count"

Path(LENGTH_DIR).mkdir(parents=True, exist_ok=True)
Path(COUNT_DIR).mkdir(parents=True, exist_ok=True)

# ==========================================
# TOTAL PROTEINS IN MOUSE PROTEOME
# ==========================================
