...
input_fasta = r"zebrafish\dataforFig8\zebrafish_missing_residues.fa"

output_file = r"zebrafish\dataforFig8\fig8B_missing_residue_complexity.tsv"

log_file = r"zebrafish\dataforFig8\fig8B_missing_complexity.log"
