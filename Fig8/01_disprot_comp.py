...
input_file = r"celegans\dataforFig8\Disprot_Celegans.tsv"

output_file = r"celegans\dataforFig8\fig8A_disprot_complexity.tsv"

log_file = r"celegans\dataforFig8\fig8A_disprot_complexity.log"
