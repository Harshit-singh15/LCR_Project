...
metrics_file = r"fruitfly\dataforFig6\reference_metrics.tsv"

confusion_file = r"fruitfly\dataforFig6\protein_confusion.tsv"

output_dir = r"fruitfly\dataforFig6\plot_tables"
